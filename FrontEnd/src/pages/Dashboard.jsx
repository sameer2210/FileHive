...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 pt-4 px-2 sm:px-4 pb-20 lg:pb-4">
              ...
              <div className="border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center min-w-0 flex-1">
                    {/* Mobile Menu Button */}
                    <button
                      className="p-2 lg:hidden text-gray-500 hover:text-gray-700 mr-3 flex-shrink-0"
                  ...
                  <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
                    ...
                    <button className="p-2 hover:bg-gray-100 rounded-xl relative flex-shrink-0">
                ...
                {activeTab === 'summary' && (
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                      <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-4 sm:p-6 text-white relative overflow-hidden">
                      ...
                      <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-4 sm:p-6 text-white relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-white/10 rounded-full -mr-8 -mt-8 sm:-mr-10 sm:-mt-10"></div>
                      ...
                      <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-4 sm:p-6 text-white relative overflow-hidden sm:col-span-2 lg:col-span-1">
                        <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-white/10 rounded-full -mr-8 -mt-8 sm:-mr-10 sm:-mt-10"></div>
                ...
                {activeTab === 'folders' && (
                  <div>
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 space-y-4 sm:space-y-0">
                      <h2 className="text-xl sm:text-2xl font-bold text-gray-900">My Folders</h2>
