      ...
      <div className="max-w-md w-full space-y-2">
        <div className="rounded shadow-2xl font-mono p-8 mt-8">
            ...
            <form onSubmit={handleSubmit(onSubmitDetails)} className="space-y-4 mt-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border-b-3 rounded focus:outline-none duration-200 ${errors.name ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white hover:border-gray-400'
                      }`}
                    placeholder="Enter your full name"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border-b-3 rounded focus:outline-none duration-200 ${errors.email ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white hover:border-gray-400'
                      }`}
                    placeholder="Enter your email"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border-b-3 rounded focus:outline-none duration-200 ${errors.password ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white hover:border-gray-400'
                      }`}
                    placeholder="Create a strong password"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border-b-3 rounded focus:outline-none duration-200 ${errors.confirmPassword ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white hover:border-gray-400'
                      }`}
                    placeholder="Confirm your password"
                  />
              ...
              <div>
                <button
                  ...
                  className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white transition-all duration-200 ${!isFormValid || otpStatus === 'loading' || isLoading ? 'bg-gray-800 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-700 hover:shadow-lg transform hover:-translate-y-0.5'
                    }`}
                >
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                <button
                  ...
                  className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white transition-all duration-200 ${otp.length !== 6 || otpStatus === 'loading' || isLoading ? 'bg-gray-800 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-700 hover:shadow-lg transform hover:-translate-y-0.5'
                    }`}
                >
                  {otpStatus === 'loading' || isLoading ? (
                    <Loader size="sm" />
              ...
              <p className="text-sm text-center">
                Didn't receive OTP?{' '}
                <button onClick={() => onSubmitDetails(getValues())} className="text-teal-600 hover:underline">
                  Resend
                </button>
              </p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-800">
              Already have an account?{' '}
              <Link to="/login" className="font-medium text-teal-600 hover:teal-purple-500 transition-colors hover:underline">
                Sign in here
              </Link>
            </p>
          </div>
